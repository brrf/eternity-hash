...
class Navbar extends React.Component {
  ...
  render() {
    ...
    let authenticationLink = loginStatus
      ? { link: "/authentication/logout", title: "Logout" }
      : { link: "/authentication/login", title: "Login" };
      ...
      <div className="navbar-parent">
        <div className="navbar">
          ...
          <div className="navbar-right">
            <Link className="navbar-item" to="/hashes">
              Schedule A Hash
            </Link>
            ...
            <Link to="/cart">
              <FontAwesomeIcon
                icon={faShoppingCart}
                size="1x"
                className="navbar-item cart-svg"
              />
            </Link>
            ...
            <div className="dropdown-items">
              ...
              <Link to={authenticationLink.link} className="dropdown-item">
                {authenticationLink.title}
              </Link>
              <Link to="/addpiece" className="dropdown-item">
                Add Piece
              </Link>
...
function mapStateToProps(state) {
  const fname = state.authedUser.authedUser
